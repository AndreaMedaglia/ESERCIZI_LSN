...
double variationalWaveFunction(double v)
{
	double _mu=0.812;
	double _sigma=0.647;
	double num1=(v-_mu)*(v-_mu)/(2*_sigma*_sigma);
	double num2=(v+_mu)*(v+_mu)/(2*_sigma*_sigma);
	//return 1.0;
	//return exp(-0.5*v*v);
...
double variationalWaveFunction_second(double v)
{
	...
	double num1=(v-_mu)*(v-_mu)/(2*_sigma*_sigma);
	double num2=(v+_mu)*(v+_mu)/(2*_sigma*_sigma);
	double num3=(v-_mu)/(_sigma*_sigma);
	double num4=(v+_mu)/(_sigma*_sigma);
	//return 0;
	//return v*v*exp(-0.5*v*v) - exp(-0.5*v*v);
	return (exp(-num1)*(num3*num3-1.0/(_sigma*_sigma))+exp(-num2)*(num4*num4-1.0/(_sigma*_sigma)));
}
